...
import { validateAmount, validateDisplayDate, validateOccurrences } from "@/utils/validation";
...
export function AddIncomeModal({ visible, onClose, editing }: Props) {
  ...
  const handleSave = () => {
    ...
    const payload = {
      ...
      recurrenceType,
      occurrences: recurrenceType === "one-time" ? 1 : parseInt(occurrences, 10),
    };
    if (editing) {
      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <View style={styles.field}>
            ...
            <View style={[inputStyle, show("date") ? { borderColor: colors.income } : null]}>
